package darkapi.webwalker.web.loader.impl;
...
import darkapi.webwalker.web.loader.LoaderSettings;
...
public class OptimizedWebLoader extends AbstractWebLoader {
    ...
    public OptimizedWebLoader(Web web) {
        super(web);
    }
    ...
    public String parseObject(WebNode node) {
        ...
        sb.append(node.getPlane()).append(LoaderSettings.SEPARATOR);
    ...
    private WebNode parseNodeString(String nodeString) {
        ...
        try {
            ...
            return getWeb().addNew(new WebNode(id, new Coordinate(x, y, z), name, options.toArray(new String[options.size()])));
